          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <ScrollReveal delay={0}>
              <div className="bg-surface-container-lowest border border-surface-variant/40 rounded-xl p-6 flex gap-4 hover:border-secondary/50 transition-all duration-300 hover:-translate-y-1 group h-full">
                ...
                <div>
                  <h3 className="text-base font-bold text-white mb-1 transition-colors group-hover:text-secondary">Pemesanan Online 24/7</h3>
            ...
            <ScrollReveal delay={100}>
              <div className="bg-surface-container-lowest border border-surface-variant/40 rounded-xl p-6 flex gap-4 hover:border-secondary/50 transition-all duration-300 hover:-translate-y-1 group h-full">
                ...
                <div>
                  <h3 className="text-base font-bold text-white mb-1 transition-colors group-hover:text-secondary">Jeda Detailing & Inspeksi 3 Jam</h3>
                  <p className="text-xs md:text-sm text-zinc-400 leading-relaxed">
            ...
            <ScrollReveal delay={200}>
              <div className="bg-surface-container-lowest border border-surface-variant/40 rounded-xl p-6 flex gap-4 hover:border-secondary/50 transition-all duration-300 hover:-translate-y-1 group h-full">
                ...
                <div>
                  <h3 className="text-base font-bold text-white mb-1 transition-colors group-hover:text-secondary">Tarif Pasti Tanpa Biaya Tersembunyi</h3>
                  <p className="text-xs md:text-sm text-zinc-400 leading-relaxed">
            ...
            <ScrollReveal delay={300}>
              <div className="bg-surface-container-lowest border border-surface-variant/40 rounded-xl p-6 flex gap-4 hover:border-secondary/50 transition-all duration-300 hover:-translate-y-1 group h-full">
                ...
                <div>
                  <h3 className="text-base font-bold text-white mb-1 transition-colors group-hover:text-secondary">Perlindungan Data (UU PDP No. 27/2022)</h3>
                  <p className="text-xs md:text-sm text-zinc-400 leading-relaxed">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="bg-surface-container-lowest border border-surface-variant/40 hover:border-secondary/50 rounded-xl p-6 transition-all duration-300 hover:-translate-y-1 group">
                <div className="flex items-center gap-3 mb-3">
                  ...
                  <h3 className="text-lg font-bold text-white transition-colors group-hover:text-secondary">Lepas Kunci (Self-Drive)</h3>
                </div>
                ...
                >
                  Cari Mobil Lepas Kunci <ArrowRight className="w-3.5 h-3.5 group-hover:translate-x-1.5 transition-transform duration-300" />
                </Link>
              </div>
              ...
              <div className="bg-surface-container-lowest border border-surface-variant/40 hover:border-secondary/50 rounded-xl p-6 transition-all duration-300 hover:-translate-y-1 group">
                <div className="flex items-center gap-3 mb-3">
                  ...
                  <h3 className="text-lg font-bold text-white transition-colors group-hover:text-secondary">Dengan Sopir (With Driver)</h3>
                </div>
                <p className="text-xs md:text-sm text-zinc-300 leading-relaxed mb-4">
                ...
                <Link 
                  ...
                  className="text-xs font-semibold text-secondary hover:text-white inline-flex items-center gap-1 group"
                >
                  Cari Mobil dengan Sopir <ArrowRight className="w-3.5 h-3.5 group-hover:translate-x-1.5 transition-transform duration-300" />
                </Link>
              </div>
            </div>
          </section>
          ...
          <section className="max-w-5xl mx-auto mb-16">
            <div className="bg-surface-container-lowest border border-surface-variant/40 rounded-2xl p-8 md:p-10">
              <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 mb-6">
                ...
                >
                  Lihat Detail Semua Cabang <span className="transition-transform duration-300 group-hover:translate-x-1">→</span>
                </Link>
              </div>
                  ...
                  {activeBranches.map(branch => (
                    <div key={branch.id} className="bg-surface-container-low/50 border border-surface-variant/30 hover:border-secondary/40 rounded-lg p-4 transition-all duration-300 hover:-translate-y-0.5">
                      ...
                      <p className="text-xs text-zinc-400 mt-2 flex items-center gap-1.5">
                        ...
                        {branch._count.vehicles > 0 ? `${branch._count.vehicles} armada siap jalan` : 'Armada sedang bertugas'}
                      </p>
                    </div>
                  ))}
                </div>
        ...
        <ScrollReveal>
          <section className="max-w-5xl mx-auto text-center bg-gradient-to-r from-surface-container-low via-surface-container-lowest to-surface-container-low border border-surface-variant/50 rounded-2xl p-10 md:p-12">
            ...
            <div className="flex flex-col sm:flex-row justify-center items-center gap-4">
              ...
              >
                Pilih Armada Sekarang <ArrowRight className="w-4 h-4 transition-transform duration-300 group-hover:translate-x-1" />
              </Link>
              <Link 
                href="/contact" 
