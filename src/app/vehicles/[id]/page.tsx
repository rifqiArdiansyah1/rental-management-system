          ...
          <div className="relative z-10 w-full px-margin-mobile md:px-margin-desktop max-w-container-max mx-auto pb-12">
            <div className="flex flex-col md:flex-row justify-between items-end gap-gutter">
              <div className="flex flex-col">
                <span className="font-label-caps text-label-caps text-secondary mb-2 tracking-widest uppercase">{category.name}</span>
                <h1 className="font-display-lg-mobile md:font-display-lg text-display-lg-mobile md:text-display-lg text-on-surface mb-2">{vehicle.plateNumber}</h1>
              ...
              <div>
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                  ...
                  <div className="bg-surface-container rounded p-6 flex flex-col gap-2 ambient-glow">
                    ...
                    <span className="font-label-caps text-label-caps text-on-surface-variant uppercase mt-2">Branch</span>
              ...
              <div className="bg-surface-container rounded-lg p-8 sticky top-28 border border-white/5 ambient-glow flex flex-col gap-6">
                ...
                <div className="flex flex-col gap-4">
                  <div className="flex flex-col gap-2">
                    <label className="font-label-caps text-label-caps text-on-surface-variant uppercase">Pick-up Date</label>
                    <input className="bg-background border border-surface-variant rounded text-on-surface px-4 py-3 focus:outline-none focus:border-secondary focus:ring-1 focus:ring-secondary font-body-md text-body-md" type="date" />
                  </div>
                  <div className="flex flex-col gap-2">
                    <label className="font-label-caps text-label-caps text-on-surface-variant uppercase">Return Date</label>
                    <input className="bg-background border border-surface-variant rounded text-on-surface px-4 py-3 focus:outline-none focus:border-secondary focus:ring-1 focus:ring-secondary font-body-md text-body-md" type="date" />
                  </div>
                </div>
