      ...
      <div className="bg-surface-container-high border border-outline-variant/30 rounded-lg p-6 shadow-2xl backdrop-blur-xl flex flex-col md:flex-row items-end gap-6">
        <div className="w-full md:w-1/3 flex flex-col gap-2">
          ...
          <div className="relative">
            <select 
              ...
              className="w-full bg-surface border border-outline-variant rounded p-3 text-on-surface font-body-md focus:border-secondary focus:ring-1 focus:ring-secondary appearance-none"
            >
        ...
        <div className="w-full md:w-auto md:ml-auto">
          <button 
            ...
            className="w-full md:w-auto bg-surface-container-lowest border border-secondary text-secondary font-button text-button px-8 py-3 rounded-DEFAULT hover:bg-secondary/10 transition-colors flex items-center justify-center gap-2 h-[46px]"
          >
