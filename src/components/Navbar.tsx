  ...
  return (
    <nav className="bg-background/90 sticky top-0 z-50 w-full backdrop-blur-md border-b border-surface-variant/30">
      <div className="flex justify-between items-center h-20 px-margin-mobile md:px-margin-desktop max-w-container-max mx-auto">
        {/* Brand */}
        <Link href="/" className="font-display-lg text-headline-md tracking-tighter text-secondary cursor-pointer active:scale-95 transition-transform flex-shrink-0">
          Prestige Motion
        </Link>
        ...
        <div className="flex items-center gap-3 flex-shrink-0">
          {user ? (
            <>
              <Link href="/dashboard" className="font-button text-xs tracking-wide uppercase font-semibold text-background bg-secondary px-4 lg:px-5 py-2.5 rounded-DEFAULT hover:bg-secondary-fixed transition-colors cursor-pointer inline-block">
                Dashboard
              </Link>
              <LogoutButton />
            </>
            ...
            <div className="flex items-center gap-2">
              <Link href="/login" className="font-button text-xs tracking-wide uppercase font-semibold text-secondary border border-secondary/60 px-4 lg:px-5 py-2.5 rounded-DEFAULT hover:bg-secondary hover:text-background transition-colors cursor-pointer inline-block">
                Masuk
              </Link>
            </div>
          )}
